...
export const DistributionProcessSection = ({ cards }: WhyChooseSectionProps) => {
  return (
    <section className="py-16 bg-white border border-primary rounded-md">
      <div className="container mx-auto px-6 text-center">
        <h2 className="text-3xl lg:text-4xl text-primary font-bold mb-4">
         Distributorship Process-Step by Step
        </h2>
        <p className="text-gray-600 mb-12">
Follow these simple steps to become a valued distributor of kaki herbals and grow your business with us.
